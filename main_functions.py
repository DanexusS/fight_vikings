...
def step_and_draw_attack(creature, size_step_attack):
    ...
    creature.weapon.rect.x = PLAYER_CENTER.x + radius * math.sin(creature.angle_attack_move)
    creature.weapon.rect.y = PLAYER_CENTER.y + radius * math.cos(creature.angle_attack_move)
    # Шаг
